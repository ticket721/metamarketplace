...
module.exports = {
    daiplusoffer_invalid_nonce: async function daiplusoffer_invalid_nonce() {
        ...
        )).to.eventually.be.rejectedWith('MMv0::checkDaiPlusOffer | invalid nonce for ticket offer');
