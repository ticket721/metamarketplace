...
module.exports = {
    seal_invalid_buyer_mode: async function seal_invalid_buyer_mode() {
        ...
        await expect(MetaMarketplace.verifySeal(addr, nums, bdata)).to.eventually.be.rejectedWith('MMv0::verifySeal | invalid identity mode for buyer');
        return expect(MetaMarketplace.seal(addr, nums, bdata)).to.eventually.be.rejectedWith('MMv0::seal | invalid identity mode for buyer');
