...
module.exports = {
    sealSale_missing_currency_number: async function sealSale_missing_currency_number() {
        ...
        await expect(MetaMarketplace.sealSale(id, [], addr, bs)).to.eventually.be.rejectedWith('MM::sealSale | missing uints[0] (currency number)');
