...
const { CHAIN_ID, SCOPE_INDEX, CONTRACT_NAME, ZADDRESS } = require('./constants');

module.exports = {
    daiplusoffer_no_relayer_restriction: async function daiplusoffer_no_relayer_restriction() {
        ...
        await MetaMarketplace.checkDaiPlusOffer(
            [TicketOwner, TicketBuyer, ZADDRESS],
        ...
        await MetaMarketplace.sealDaiPlusOffer(
            [TicketOwner, TicketBuyer, ZADDRESS],
            [DaiPlusOffer.auction.ticket, DaiPlusOffer.auction.nonce, DaiPlusOffer.amount, DaiPlusOffer.reward],
            [DaiPlusApprove.txparams.nonce, DaiPlusApprove.txparams.gasLimit, DaiPlusApprove.txparams.gasPrice],
            `${seller_signature.hex}${buyer_signature.hex.slice(2)}${dpapprove_signature.hex.slice(2)}`,
