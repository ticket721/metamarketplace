...
module.exports = {
    daioffer_invalid_seller_signature: async function daioffer_invalid_seller_signature() {
        ...
        await expect(MetaMarketplace.checkDaiOffer(
            ...
            `${buyer_signature.hex}${buyer_signature.hex.slice(2)}`,
            {
                from: AuctionRelayer
            }
        )).to.eventually.be.rejectedWith('MMv0::checkDaiOffer | failed seller signature check');
        ...
        )).to.eventually.be.rejectedWith('MMv0::sealDaiOffer | failed seller signature check');
