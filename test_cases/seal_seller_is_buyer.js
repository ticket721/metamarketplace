...
module.exports = {
    seal_seller_is_buyer: async function seal_seller_is_buyer() {
        ...
        const TicketBuyerWallet = TicketOwnerWallet;
        ...
        await expect(MetaMarketplace.verifySeal(addr, nums, bdata)).to.eventually.be.rejectedWith('MMv0::verifySeal | seller is also buyer');
        return expect(MetaMarketplace.seal(addr, nums, bdata)).to.eventually.be.rejectedWith('MMv0::seal | seller is also buyer');
