...
module.exports = {
    seal_invalid_seller_mode: async function seal_invalid_seller_mode() {
        ...
        await expect(MetaMarketplace.verifySeal(addr, nums, bdata)).to.eventually.be.rejectedWith('MMv0::verifySeal | invalid identity mode for seller');
        return expect(MetaMarketplace.seal(addr, nums, bdata)).to.eventually.be.rejectedWith('MMv0::seal | invalid identity mode for seller');
