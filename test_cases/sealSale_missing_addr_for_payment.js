...
module.exports = {
    sealSale_missing_addr_for_payment: async function sealSale_missing_addr_for_payment() {
        ...
        await expect(MetaMarketplace.sealSale(id, uints, addr.slice(0, 4), bs)).to.eventually.be.rejectedWith('MM::sealSale | not enough space on addr (1)');
