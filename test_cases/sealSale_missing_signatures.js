...
module.exports = {
    sealSale_missing_signatures: async function sealSale_missing_signatures() {
        ...
        await expect(MetaMarketplace.sealSale(id, uints, addr, bs.slice(0, 132))).to.eventually.be.rejectedWith('MM::sealSale | not enought space on bs (1)');
