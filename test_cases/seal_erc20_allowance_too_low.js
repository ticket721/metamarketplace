...
module.exports = {
    seal_erc20_allowance_too_low: async function seal_erc20_allowance_too_low() {
        ...
        await EthersDaiInstance.functions.approve(MetaMarketplace.address, BuyPrice - 1);
        ...
        await expect(MetaMarketplace.verifySeal(addr, nums, bdata)).to.eventually.be.rejectedWith('MMv0::verifyPayment | allowance too low');
