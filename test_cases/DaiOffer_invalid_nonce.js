...
module.exports = {
    daioffer_invalid_nonce: async function daioffer_invalid_nonce() {
        ...
        )).to.eventually.be.rejectedWith('MMv0::checkDaiOffer | invalid nonce for ticket offer');
        ...
        )).to.eventually.be.rejectedWith('MMv0::ticketNonceCheck | invalid nonce for ticket offer');
    }
}
