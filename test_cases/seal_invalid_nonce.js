...
module.exports = {
    seal_invalid_nonce: async function seal_invalid_nonce() {
        ...
        await expect(MetaMarketplace.verifySeal(addr, nums, bdata)).to.eventually.be.rejectedWith('MMv0::verifySeal | invalid offer nonce');
        return expect(MetaMarketplace.seal(addr, nums, bdata)).to.eventually.be.rejectedWith('MMv0::seal | invalid offer nonce');
