...
module.exports = {
    sealSale_invalid_nonce: async function sealSale_invalid_nonce() {
        ...
        const nonce = (await MetaMarketplace.getNonce(ticket_id)).toNumber() + 1;
        ...
        await expect(MetaMarketplace.sealSale(id, uints, addr, bs)).to.eventually.be.rejectedWith('MM::sealSale | invalid nonce');
