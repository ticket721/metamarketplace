...
module.exports = {
    sealSale_missing_actor_addresses: async function sealSale_missing_actor_addresses() {
        ...
        await expect(MetaMarketplace.sealSale(id, uints, [], bs)).to.eventually.be.rejectedWith('MM::sealSale | missing addr[0-3] (actors addresses)');
