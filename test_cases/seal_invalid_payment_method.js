...
module.exports = {
    seal_invalid_payment_method: async function seal_invalid_payment_method() {
        ...
        await expect(MetaMarketplace.verifySeal(addr, nums, bdata)).to.eventually.be.rejectedWith('MMv0::verifySeal | invalid payment method');
        return expect(MetaMarketplace.seal(addr, nums, bdata)).to.eventually.be.rejectedWith('MMv0::seal | invalid payment method');
