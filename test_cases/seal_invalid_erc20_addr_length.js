...
module.exports = {
    seal_invalid_erc20_addr_length: async function seal_invalid_erc20_addr_length() {
        ...
        await expect(MetaMarketplace.verifySeal(err_addr, nums, bdata)).to.eventually.be.rejectedWith('MMv0::verifyPayment | invalid address argument length');
        return expect(MetaMarketplace.seal(err_addr, nums, bdata)).to.eventually.be.rejectedWith('MMv0::processPayment | invalid address argument length');
