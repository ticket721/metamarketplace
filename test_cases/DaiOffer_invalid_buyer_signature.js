...
module.exports = {
    daioffer_invalid_buyer_signature: async function daioffer_invalid_buyer_signature() {
        ...
        await expect(MetaMarketplace.checkDaiOffer(
            ...
            `${seller_signature.hex}${seller_signature.hex.slice(2)}`,
            {
                from: AuctionRelayer
            }
        )).to.eventually.be.rejectedWith('MMv0::checkDaiOffer | failed buyer signature check');
        ...
        )).to.eventually.be.rejectedWith('MMv0::sealDaiOffer | failed buyer signature check');
