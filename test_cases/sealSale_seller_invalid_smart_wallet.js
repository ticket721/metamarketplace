...
module.exports = {
    sealSale_seller_invalid_smart_wallet: async function sealSale_seller_invalid_smart_wallet() {
        ...
        const sellerInstance = await SmartWalletMockArtifact.new(buyer.address);
        const seller = {
        ...
        await expect(MetaMarketplace.sealSale(id, uints, addr, bs)).to.eventually.be.rejectedWith('MM::sealSale | invalid seller signature');
