...
module.exports = {
    seal_invalid_erc20_nums_length: async function seal_invalid_erc20_nums_length() {
        ...
        await expect(MetaMarketplace.verifySeal(addr, err_nums, bdata)).to.eventually.be.rejectedWith('MMv0::verifyERC20Payment | invalid nums argument length');
        return expect(MetaMarketplace.seal(addr, err_nums, bdata)).to.eventually.be.rejectedWith('MMv0::processERC20Payment | invalid nums argument length');
